...
int yolo(){
    ...
    rc = execCommand("/jb/usr/local/bin/dropbear", "-R", "--shell" ,"/jb/bin/sh", "-E",0,0);
    printf("***** Launching amfidebilitate******\n");
    pid_t amfidebPid = execCommand("/jb/amfidebilitate", "", 0,0,0,0,0);
    ...
    // Now do platformize
    platformizeProcAtAddr(amfideb_proc);
    return 0;
}
